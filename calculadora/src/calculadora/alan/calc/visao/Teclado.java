...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		setLayout(layout);
		c.weightx = 1;// Preenche espaços externos do eixo 'x'!
		c.weighty = 1;// Preenche espaços externos do eixo 'y'!
		c.fill = GridBagConstraints.BOTH;// Preenche os espaços em branco interno!
		// Linha 1

		//c.gridwidth = 2;
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		// add botões com método e seus parâmentros!
		...
		// Linha 5
		c.gridwidth = 2;
		// extende o botão no espaço em branco que não foi criado botão!
		adicionarBotao("0", COR_CINZA_CLARO, c, 0, 4);
		c.gridwidth = 1;// Retoma o tamanho do botão, que o de antes foi extendido
