package calculadora.alan.calc.modelo;
...
public class Memoria {
	...
	private enum TipoComando {
		ZERAR, SINAL, NUMERO, DIV, MULT, SUB, SOMA, IGUAL,PORCENTAGEM, VIRG;
	...
	private String obterResultado2() {
		if (ultimaOperacao == null || ultimaOperacao == TipoComando.PORCENTAGEM) {
			return textoAtual;
		}
